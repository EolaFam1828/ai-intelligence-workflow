...
5. Do not publish:
   ...
   - private schemas
6. Generate a dated public-safe snapshot.
   - run `scripts/architecture_snapshot.sh <private-repo-path>`
   - add files under `docs/snapshots/`
7. Draft or update case studies with `docs/CASE-STUDY-TEMPLATE.md`.
8. Run checks before each publish.
